...
def _apply_overlay(
    experiment: Experiment, overlay_config: dict, base_path: Optional[str]
):
...
def load_experiment(
    ...
    overlay_experiment_config: dict,
    ...
    experiment = _load_base_experiment(base_experiment_config, base_path)

    # Apply environment overlay
    if overlay_experiment_config:
        _apply_overlay(experiment, overlay_experiment_config, base_path)
